...
export default function splash({ name, org, logo, active, total, channels, iframe }){
  let div = dom('.splash',
    ...
    dom('p',
      ...
      ' on Slack. <br><br> By joining this Slack you agree to abide by the Code of Conduct. 8 min read: '
    ),
	dom('a href=https://docs.google.com/document/d/1nMIa603CWpgTh-gkJoEZhrMULfUJ_OeBsMa-BE7rDT4/edit?usp=sharing target=_blank', 'Code of Conduct <br><br>'),
    dom('p.status',
      active
        ? [
